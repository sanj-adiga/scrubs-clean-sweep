...
stone_block = pygame.image.load("greyChiseledBlock.png")
dirt_block = pygame.image.load("dirtBlock.png")
dirt_block = pygame.transform.scale(dirt_block, (30, 30))
stone_block = pygame.transform.scale(stone_block, (30, 30))
cave_block = pygame.image.load("caveBlock.png")
cave_block = pygame.transform.scale(cave_block, (30, 30))
door_block = pygame.image.load('tile_0150.png')
